 ...
 * {@link FavoriteAirportsListFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class FavoriteAirportsListFragment extends Fragment {

    private OnFragmentInteractionListener mListener;

    public FavoriteAirportsListFragment() {
